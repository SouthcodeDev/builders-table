...
export const ACTIVE_PASSPORT: Passport = {
  ...
  // Newest first. `number` is the position in the collection counting from the
  // beginning, which is why it runs DOWN the list — stamp 31 is the most recent.
  stamps: [
    {
      id: 'stamp-31',
      number: 31,
    ...
    {
      // The one the share card in the handoff is drawn from.
      id: 'stamp-26',
      number: 26,
      ...
      kind: 'bounce',
      areas: ['Woodstock', 'Muizenberg', 'Observatory'],
      hours: 3,
      withFriends: 3,
    },
  ],
